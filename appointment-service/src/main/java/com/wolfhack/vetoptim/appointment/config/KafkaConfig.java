...
public class KafkaConfig {
    ...
    private String notificationAppointmentTopic;
    ...
    @Bean
    public NewTopic taskAppointmentTopic() {
        return TopicBuilder.name(taskAppointmentTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic notificationAppointmentTopic() {
        return TopicBuilder.name(notificationAppointmentTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
