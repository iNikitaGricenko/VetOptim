...
public class VaccinationController {
	...
	public ResponseEntity<List<Vaccination>> getVaccinationsForPet(@PathVariable Long petId) {
		List<Vaccination> vaccinations = vaccinationService.getVaccinationsForPet(petId);
		return ResponseEntity.ok(vaccinations);
	}

	@PostMapping("/pet/{petId}")
	public ResponseEntity<Vaccination> createVaccination(@PathVariable Long petId, @RequestBody Vaccination vaccination) {
	...
	public ResponseEntity<Vaccination> updateVaccination(@PathVariable Long vaccinationId, @RequestBody Vaccination vaccinationDetails) {
